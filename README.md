# nvim-treesitter-queries-yuck

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-yuck/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-yuck/actions/workflows/validate.yml)

Neovim tree-sitter queries for **yuck**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-yuck",
...
- [ ] Changes are scoped to `yuck` — do not include files for other languages
